...
//  StoryPrompt
//
//  Created by user199344 on 6/29/21.
//
...
class AddStoryPromptViewController: UIViewController {
    ...
    @IBOutlet weak var adjectiveTextView: UITextField!
    @IBOutlet weak var verbTextView: UITextField!
    ...
    @objc func updateStoryPrompt() {
        ...
        storyPrompt.adjective = adjectiveTextView.text ?? ""
        storyPrompt.verb = verbTextView.text ?? ""
    }
